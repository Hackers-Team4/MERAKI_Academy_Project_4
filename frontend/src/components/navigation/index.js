...
const Navigation = (props) => {
	...
	return <div className="navigation">
		...
		<div className="allLinks">
			...
			{props.token2 ? <div className="Navigation">
				<svg className="links" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16" onClick={() => { props.token4(localStorage.setItem("token", "")); history.push("/") }
				}>
