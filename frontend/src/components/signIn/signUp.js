...
const Register = ({ setUsers }) => {
  ...
  return (
    ...
    <svg style={{marginTop:"30px"}} xmlns="http://www.w3.org/2000/svg" width="75" height="75" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
...
<h1>SIGN UP</h1>
      ...
      <din className="singUp" style={{marginTop:"20px"}}><p>You already have an account ?<span><Link to="/login"> log in</Link></span></p> </din>
