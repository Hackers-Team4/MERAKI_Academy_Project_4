  ...
  return (
    <><div className="signUpImg">
      ...
      <div className="allInput">
        ...
        <input className="inputs1" type="text" placeholder="firstName here" onChange={(e) => {
          setfirstName(e.target.value)
        }} />
        <input className="inputs1" type="text" placeholder="LastName here " onChange={(e) => {
          setLastName(e.target.value)
        }} />


        <input className="inputs1" type="date" placeholder="dateOfBirth here" onChange={(e) => {
        ...
        <input className="inputs1" type="tel" placeholder="phoneNumber here" onChange={(e) => {
          setphoneNumber(e.target.value)
        }} />


        <input className="inputs1" type="text" placeholder="image here " onChange={(e) => {
          setimage(e.target.value)
        }} />

        <input className="inputs1" type="text" placeholder="email here" onChange={(e) => {
          setemail(e.target.value)
        }} />
        <input className="inputs1" type="password" placeholder="password here" onChange={(e) => {
